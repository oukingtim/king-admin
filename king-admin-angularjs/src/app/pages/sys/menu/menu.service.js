(function () {
    ...
    /** @ngInject */
    function MenuService($resource,toastr,CommonService) {

        var rest = $resource('sys/menu/:id', {}, {
            'create': {method: 'POST'},
            'update': {method: 'PUT'},
        });

        function getSmartData(param,callback) {
            $resource('sys/menu/getSmartData', {}, {
                'query': {method: 'POST'}
            }).query(param,
                function (data) {
                    console.log(data);
        ...
        function getMenuTree(param,callback) {
            $resource('sys/menu/getMenuTree', {}, {
                'get': {method: 'GET'}
            }).get(param,
                function (data) {
                    console.log(data);
